...
public class PhoneDetailsScreenActivity extends AppCompatActivity {
    ...
    public void back(View arg0) {
        startActivity(new Intent(this, FirstTimeUserScreenActivity.class));
    }
    ...
    public void showInterAd() {
            ...
            intent.setClass(PhoneDetailsScreenActivity.this, UserDetailsScreenActivity.class);
