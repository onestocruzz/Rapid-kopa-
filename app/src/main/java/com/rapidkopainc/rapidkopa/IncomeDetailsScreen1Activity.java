...
public class IncomeDetailsScreen1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_incomedetails1);
    ...
    public void back(View arg0) {
        startActivity(new Intent(this, IncomeDetailsScreenActivity.class));
    }
    public void showInterAd() {

            this.dialog.dismiss();
            Intent intent= new Intent();
            intent.setClass(IncomeDetailsScreen1Activity.this, IdentificationDetailsScreenActivity.class);
